...
import static com.company.entity.classes.Admin.notConfirmedGoods;
...
public class ProductRequest {
    ...
    void pressonProduct(MouseEvent event) {
        notConfirmedGoods.get(listviewProduct.getSelectionModel().getSelectedIndex()).setConfirmStatus(true);
        Admin.realGoods.add(notConfirmedGoods.get(listviewProduct.getSelectionModel().getSelectedIndex()));
        initialize();
    }
